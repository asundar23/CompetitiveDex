...
public class BreedingAdapter extends BaseAdapter{
	...
	public BreedingAdapter(Context c, String[] m, String[] t,int[] back,String n)
	{
		ctx = c;
		moves = m;
		types = t;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (rl == null) {
            ...
            li.inflate(R.layout.breeding_text_view, rl, true);
            
            move = (TextView) rl.findViewById(R.id.egg_move);
            type = (TextView) rl.findViewById(R.id.egg_type);
