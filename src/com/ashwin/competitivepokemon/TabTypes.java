...
public class TabTypes extends FragmentActivity implements TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pager.setAdapter(new ViewPagerAdapter3(getSupportFragmentManager()));
...
class ViewPagerAdapter3 extends FragmentPagerAdapter
{
	...
	public Fragment getItem(int arg0) {
		...
		if(arg0==0) fragment = new Chart();
		if(arg0==1) fragment = new Legend();
